...
public class Project  implements java.io.Serializable {
    ...
    public Project(int id, Campigantype campigantype, Currency currency, Customertype customertype, User users, String name, int value, int type, int units, int uprice, int minimumamount, Date startdate, Date enddate, int status) {
        this.id = id;
    ...
    public Project(int id, Campigantype campigantype, Currency currency, Customertype customertype, User users, String name, String image, String video, int value, int type, int units, int uprice, int minimumamount, Date startdate, Date enddate, int status,Company company, Teamdetails teamdetailses, Investsectorsmap investsectorsmaps, Marketdetails marketdetailses) {
       this.id = id;
       this.campigantype = campigantype;
       this.currency = currency;
       this.customertype = customertype;
